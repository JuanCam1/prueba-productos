...
const Navbar = () => {
  return (
    <nav className="top-0 left-0 z-50 fixed flex justify-center items-center bg-white dark:bg-gray-900 shadow-md border-gray-200 dark:border-gray-600 border-b w-full h-16 text-white">
